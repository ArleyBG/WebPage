document.addEventListener("DOMContentLoaded", () => {
  ...
  const imagenFondo = document.querySelector(".features img");
  if (imagenFondo) {
    imagenFondo.src = "images/bg-curvy-desktop.svg";
  }
  ...
  let titleExperiences = ["Satish Patel", "Bruce McKenzie", "Iva Boyd"];
  ...
  let logoFooterSrc = ["images/logo.svg"];
